...
static bool cc_is_ddrfreq_related(const char *name) { return false; }
static unsigned long cc_get_expect_ddrfreq(void) { return 0; }
static bool cc_ddr_boost_enabled(void) { return false; }
#endif
